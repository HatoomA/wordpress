...
<div id="content">
  ...
  <div class="homeHero"><img src="<?php the_field('hero_image'); ?>"></div>
          ...
          <ul class="imageList coursePrograms">
            <li class="asp">
              ...
              <div class="liContent">
                ...
                <a class="buttonLink" href="./registerSeattle#asp">Read More</a>
              </div>
            </li>
            <li class="hc">
              ...
              <div class="liContent">
                ...
                <a class="buttonLink" href="./registerSeattle#hc">Read More</a>
              </div>
            </li>
            <li class="sc">
              ...
              <div class="liContent">
                ...
                <a class="buttonLink" href="./registerSeattle#sc">Read More</a>
              </div>
            </li>
