      ...
      <main id="main" class="m-all t-3of3 d-7of7 cf" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        ...
        <div class="registerFormWrapper">
          <?php 
            ...
            $classType = (isset($_POST['classType']) ? $_POST['classType'] : 'unknown');
            $api_key    = 'YW7J-8Q1R-LVEN-ENL0';
            $form_hash  = 0;
            $subdomain  = 'cc4kforms.wufoo.com';
            if( $classType == 'asp'){
              $form_hash  = get_field('asp_form_hash');
            }
            elseif( $classType == 'sc' ){
              $form_hash  = get_field('sc_form_hash');
            }
            elseif( $classType == 'hc' ){
              $form_hash  = get_field('hc_form_hash');
            }
            else{
