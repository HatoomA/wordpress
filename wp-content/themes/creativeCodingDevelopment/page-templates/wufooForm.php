<?php
/*
 Template Name: wufoo form
 *  This if a template for dropping in wufoo forms
 * 
*/
  ...
  $form_hash  = get_field('form_hash');
?>

<?php get_header(); ?>

<div id="content" class="registerForm wufooForm">
  <div id="inner-content" class="wrap cf">
      <main id="main" class="m-all t-3of3 d-7of7 cf" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
        <div class="formDescription">
          <?php echo get_field('form_description'); ?>
          <span class="form_permalink">If the form does not appear below, it can be found <a target="_blank" href="https://cc4kforms.wufoo.com/forms/<?php echo $form_hash;?>/">here</a></span>
        </div>
