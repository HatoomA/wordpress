...
jQuery(document).ready(function($) {
    ...
    var latestNews = jQuery(".latestNews")[0];
    if(latestNews){
      var latestNewsCloseButton = jQuery(".latestNewsCloseButton")[0];
      ...
      if( jQuery("body")[0].classList.contains("home") ){
    ...
    if( jQuery(window).scrollTop() < 5 ) {
      jQuery('#container').removeClass("browsing");
    }
    else {
      jQuery('#container').addClass("browsing");
    }
  ...
  */
  ...
  jQuery(function() {
    ...
    jQuery('.openNavButton').click(function() {
      jQuery('.openNavButton').addClass("hide");
