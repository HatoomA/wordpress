...
function custom_post_teacher() { 
	...
	register_post_type( 'teacher', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			'name' => __( 'Teachers', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Teacher', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All Teachers', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Teacher', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Edit Teachers', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New Teacher', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View Teacher', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search Teacher', 'bonestheme' ), /* Search Custom Type Title */ 
